# Fedora 44 kickstart file for Cloud-init included and OpenStack compatible Generic Cloud images on AArch64

url --url https://dl.fedoraproject.org/pub/fedora/linux/releases/44/Server/aarch64/os
text
lang en_US.UTF-8
keyboard us
timezone UTC --utc
