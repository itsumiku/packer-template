# Rocky Linux 9 kickstart file for Cloud-init included and OpenStack compatible Generic Cloud images on AArch64

url --url https://dl.rockylinux.org/pub/rocky/9/BaseOS/aarch64/os
text
lang en_US.UTF-8
keyboard us
timezone UTC --utc
