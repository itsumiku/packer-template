# Fedora 44 kickstart file for Cloud-init included and OpenStack compatible Generic Cloud images with unified (BIOS+UEFI) boot on x86_64

url --url https://dl.fedoraproject.org/pub/fedora/linux/releases/44/Server/x86_64/os
text
lang en_US.UTF-8
keyboard us
timezone UTC --utc
...
parted -s -a optimal /dev/sda -- mkpart boot $fstype 202MiB 734MiB
parted -s -a optimal /dev/sda -- mkpart root $fstype 734MiB 100%
