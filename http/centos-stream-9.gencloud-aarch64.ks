# CentOS Stream 9 kickstart file for Cloud-init included and OpenStack compatible Generic Cloud images on AArch64

url --url https://mirror.stream.centos.org/9-stream/BaseOS/aarch64/os
text
lang en_US.UTF-8
keyboard us
timezone UTC --utc
